...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        ///设置宽高限制。
        CGSize boundingSize = CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight);
        ///设置属性
        NSDictionary *attDic =@{NSFontAttributeName: self.titleLabel.font};
        CGRect contentRect =  [self.titleLabel.text boundingRectWithSize:boundingSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:attDic context:nil];
...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        ...
        CGSize titleSize =contentRect.size;
        
        
        ///设置宽高限制。
        CGSize subtitlSize = CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight);
        ///设置属性
        NSDictionary *subtitleAttDic =@{NSFontAttributeName: self.subtitleLabel.font};
        CGRect subtitleRect =  [self.subtitleLabel.text boundingRectWithSize:subtitlSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:subtitleAttDic context:nil];
