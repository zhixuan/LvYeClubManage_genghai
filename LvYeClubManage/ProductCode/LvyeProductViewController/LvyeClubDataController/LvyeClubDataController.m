...
@implementation LvyeClubDataController
...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.clubModuleId = [[NSString alloc]initWithFormat:@"%@", @"7"];
        self.clubModuleName = [[NSString alloc]initWithFormat:@"%@",@"数据统计"];
        self.clubModuleImage = FMIconFontF080;
    }
    return self;
}
