...
@interface LvyeClubAccountController ()

@end

@implementation LvyeClubAccountController
...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.clubModuleId = [[NSString alloc]initWithFormat:@"%@", @"8"];
        self.clubModuleName = [[NSString alloc]initWithFormat:@"%@",@"账户管理"];
        self.clubModuleImage = FMIconFontF0B1;
    }
    return self;
}
